...
%in Wei et al. 2014 coded to run for various analytical test cases. It was coded and developed by Derek Manheim, 
...
%The user must specify what test case to run (testfunc, options are 1,2,3), the number of MC sampling 
